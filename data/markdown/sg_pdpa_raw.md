...
[2January2013:PartsI,II,VIII,IX(exceptsections36
...
notcarriedonforpurposesofgain,orconductedonaregular,
...
Act2016,andincludesanyindividualactinginthatcapacity;
...
asanancillarypartofabusinesscarriedonforgainor
...
“creditreport”meansacommunication,whetherinwritten,oral
...
(vii) forgrantoffinancialorsocialassistance,orthe
...
“individual”meansanaturalperson,whetherlivingordeceased;

“inspector”meansanindividualappointedasaninspectorunder
...
(c) acircumstanceorconductthatmayresultinaremedy
...
(b) resident,orhavinganofficeoraplaceofbusiness,in
...
“processing”,inrelationtopersonaldata,meansthecarryingout
...
(a) the Government,including anyministry,department,
...
thepublic, andincludespersonal data whichcan beobserved
...
dataforpurposesthatareasonablepersonwouldconsiderappropriate
...
(2) ThePersonalDataProtectionCommissionisresponsibleforthe
...
relationtotheperformanceofitsfunctionsanddutiesandtheexercise
...
oftheAuthorityforthepurposeofthissection,mayconduct,withthe
...
ofanyfunctionorduty,ortheexerciseofanypower,ofthe
...
## 10.—(1) Forthepurposesofsection59,acooperationagreementis
...
issatisfiedthattheotherisperformingfunctionsinrelation
...
(b) compliancewiththerequirementisaconditionimposedby
...
vestedfunctionsunderthelawofanothercountryor territory
...
“regulatoryauthority”includestheCommissionandanyforeign
...
(2) Anorganisationisresponsibleforpersonaldatainitspossession
...
contactinformationofatleastoneoftheindividualsdesignatedunder
...
(b) developaprocesstoreceiveandrespondtocomplaintsthat
...
(3) Anyconsentgiveninanyofthecircumstancesinsubsection(2)

is not validly given for the purposes of this Act.

(4) InthisAct,referencestoconsentgiven,ordeemedtohavebeen
...
or disclosure of personal data about theindividual by an organisation
...
(2) Ifanindividualgives,orisdeemedtohavegiven,consenttothe
...
(3) Withoutlimitingsubsection(2)andsubjecttosubsection(9),an

individual(P)whoprovidespersonaldatatoanorganisation(A)with

Personal Data Protection

21 Act 2012 2020Ed.

aviewtoPenteringintoacontractwithAisdeemedtoconsenttothe
...
(4) WhereanorganisationcollectspersonaldatadisclosedtoitbyB
...
1February2021byanindividualtoanorganisationwithaviewtothe
...
(6) Withoutlimitingsubsection(2)andsubjecttosubsection(9),an

individual(P)whoentersintoacontractwithanorganisation(A)and
...
(i) fortheperformanceofthecontractbetweenPandA;
...
betweenAandBwhichisenteredintoatP’srequest,

orwhichareasonablepersonwouldconsidertobein

P’s interest;

(b) thecollectionanduseofthatpersonaldatabyB,wherethe
...
(7) WhereanorganisationcollectspersonaldatadisclosedtoitbyB
...
(a) identifyanyadverseeffectthattheproposedcollection,use
...
(a) forpurposesconsistentwiththepurposeofthatdisclosure,
...
(i) iscollectedbytheorganisationonorafter1February
...
(b) for purposes consistent with the purpose of that collection,

orfor anypurposepermitted bysubsection(1)(b) or(c), as
...
## 18. Anorganisationmaycollect,useordisclosepersonaldataabout
...
usepersonaldataaboutanindividualcollectedbefore2July2014for
...
(5) Forthepurposesofsubsection(4),theorganisationmustinform
...
(2) Anorganisationisnotrequiredtoprovideanindividualwiththe
...
(3) Subjecttosubsection(3A),an organisation mustnot provide an
...
(2) Unlesstheorganisationissatisfiedonreasonablegroundsthata
...
underitscontrolwiththecorrectionthat wasrequestedbut notmade.
...
(a) anindividual,onorafter1February2021,makesarequest
...
personaldatacollectedbyoronbehalfoftheorganisationisaccurate
...
personaldata,orremovethemeansbywhichthepersonaldatacanbe

associated with particular individuals, as soon as it is reasonable to

assume that —

(a) thepurposeforwhichthatpersonaldatawascollectedisno
...
copying,modificationordisposalofpersonaldata;or
...
(4) Despitesubsections(1), (2)and(3), a data breachthatrelates to
...
mentionedinsection26E)hasreasontobelievethatadatabreachhas
...
thatotherorganisationoftheoccurrenceofthedatabreach;
...
(3) The notification undersubsection (1) or (2) must contain, to the
...
(5) Subsection(2)doesnotapplytoanorganisationinrelationtoan

affected individual if the organisation —

(a) onorafterassessingthatthedatabreachisanotifiabledata

breach,takesanyaction,inaccordancewithanyprescribed
...
(a) anydutyorobligationunderanywrittenlaworruleoflaw,
...
(a) isadataintermediaryprocessingpersonaldataonbehalfof
...
(a) chattelsthatareattachedorintendedtobeattachedto
...
“message”meansanymessage,whetherinsound,text,visualor
...
(3) ForthepurposesofthisPart,ifaspecifiedmessageissentandat
...
(d) ifthetelephonenumberfromwhichthemessageismadeis
...
(2) Forthepurposesofsubsection(1),wheretheapplicablepurpose
...
(b) itis lawful to acquire thegoods, service, land or interest or
...
(a) thesenderofthespecifiedmessageispresentinSingapore
...
(a) toadd his or her Singapore telephone number to a register;
...
telephonenumberwasorwasnotlistedinaregisteratadatespecified
...
## 42.—(1) Everytelecommunicationsserviceprovidermustreportto
...
(e) theSingaporetelephonenumberhasnotsubsequentlybeen
...
(b) thepersonhasobtainedfromacheckerinformationthatthe

Singapore telephone number is not listed in the relevant

register(calledinthissectiontherelevantinformation)and
...
(4) Apersondoesnotcontravenesubsection(1)ifthesubscriberor

useroftheSingaporetelephonenumbertowhichaspecifiedmessage

is sent —

(a) gave clear and unambiguous consent to the sending of the

specifiedmessagetothatSingaporetelephonenumber;and

Personal Data Protection

45 Act 2012 2020Ed.

(b) theconsentisevidencedinwrittenorotherformsoastobe
...
## 43A.—(1) Thissectionappliestoaperson(calledthechecker)that,

for reward, provides to another person (P) information on whether a

Singaporetelephonenumberislistedintherelevantregister(calledin
...
(b) providetheapplicableinformationtoPinaccordancewith
...
(a) theapplicableinformationthatthecheckerprovidestoPis
...
(b) thecheckerprovidestheapplicableinformationtoPbefore
...
specifiedmessagetobemadeorauthorisesthemakingofavoicecall
...
services,land,interestoropportunity,requireasubscriberoruserofa
...
user,andanyconsentgiveninsuchcircumstanceisnotvalidlygiven.
...
(4) ForthepurposesofthisPart,asubscriberoruserofaSingapore
...
(b) inaccordancewithinstructionsgiventohimorherbyoron
...
causestobe madeor authorisesthemaking ofa voicecallcontaining
...
who,atthetimetheactwasdoneor theconduct wasengagedin,was
...
(a) inrelationtoacorporation,hasthemeaninggivenby
...
“message”,“send”,“sender”and“Singaporetelephonenumber”

have the meanings given by section 36(1).

[40/2020]

(2) InthisPart,anapplicablemessagehasaSingaporelinkinanyof
...
(c) thetelephone,mobiletelephoneorotherdevicethatisused
...
(a) whetherthetelephonenumbertowhichthemessageissent
...
knowledgeoftheownerorauthoriseduserofthetelecommunications
...
presumednottohavesent,causedtobesentorauthorisedthesending
...
(ii) wherethepersonaldatawaspubliclyavailablesolely

because of an applicable contravention, the accused

didnotknow,andwasnotrecklessastowhether,that
...
towhether,theaccusedhadthelegalrighttodoso;or
...
bytheorganisationorpublicagency,asthecasemay
...
(b) thattheaccusedusedthepersonaldatainthepossessionor
...
agency(asthecasemaybe)byorunderanyotherwrittenlaworother
...
(b) there‑identificationisnotauthorisedbytheorganisationor
...
(ii) recklessastowhetherthere‑identificationisorisnot
...
(i) theinformationontheidentityoftheaffectedperson
...
(i) permittedorrequiredbyorunderanActorotherlaw
...
(i) reasonablybelievedthat there‑identificationwasfor
...
notrecklessastowhether,theaccusedhadthelegalrightto
...
(2) Subjecttosubsection(1),theCommissionmay,withorwithout
...
complaintofthecomplainantinthewaydirectedbytheCommission.
...
operationbyanoperatorofadisputeresolutionscheme,including—
...
relationtoarequestbythecomplainantundersection21or
...
dataportingrequestbythecomplainantundersection26H.
...
(a) confirmtherefusaltoprovideaccesstothepersonaldataor
...
(c) confirmtherefusaltotransmittheapplicabledata,ordirect
...
(d) confirm,reduceordisallowafee,ordirecttheorganisation
...
givetheorganisationorperson(asthecasemaybe)anydirectionthat
...
provisionofPart3,4,5,6,6Aor6B,giveanorganisationalloranyof
...
require,bywrittennotice,theorganisationorperson(asthecasemay

be) to pay a financial penalty.

[40/2020]

(2) Subsection(1)doesnotapplyinrelationtoanycontraventionof
...
annualturnoverinSingaporeexceeds$20million—5%of
...
(5A) Forthepurposesofsubsections(3)(a)and(4A)(b),theannual

turnover inSingapore of anorganisationor a person(as thecasemay
...
(6) TheCommissionmust,indeterminingtheamountofafinancial
...
(c) whethertheorganisationorperson(asthecasemaybe),as

aresultofthenon‑compliance,gainedanyfinancialbenefit

or avoided any financial loss;

(d) whether the organisation or person (as the case may be)

tookanyactiontomitigatetheeffectsandconsequencesof
...
undersection48J(1)onanorganisationoraperson,thetimespecified

inthenoticewithinwhichwrittenrepresentationsmaybemadetothe

Commissionmustbeatleast14daysafterthedatethenoticeisserved
...
subsection(1)(d),orasextendedbytheCommissionunder
...
thecasemaybe),theCommissionmustserveanoticeofthedecision
...
Commissionservesthenoticeinsubsection(6)(a)ontheorganisation
...
(9) TheCommissionmay,onwrittenapplicationbyanorganisation
...
(b) apersonhasnotcomplied,isnotcomplyingorislikelynot
...
(2) Withoutlimitingthematterstowhichthevoluntaryundertaking
...
thevoluntaryundertakingandwiththeagreementof theorganisation

or person who gave the voluntary undertaking —

(a) varythetermsofanyundertakingincludedinthevoluntary
...
directiongivenunderparagraph(a)asifthedirectionwere
...
undertaking, and recover the costs andexpenses so incurred from the

organisation or person as a debt due to the Commission.

[40/2020]

EnforcementofdirectionsoforwrittennoticesbyCommission
...
(a) adirectionmadebytheCommissionundersection48H(2),

48I or 48L(4);

(b) awrittennoticebytheCommissionforthepaymentofany
...
purposesofenforcement,asifithadbeenanorderoriginallyobtained

in the District Court which has power to enforce it accordingly.

[40/2020]

(4) ADistrictCourtmay,forthepurposeofenforcingadirectionin

accordance with subsection (3), make any order —

(a) to secure compliance with the direction; or

(b) torequireanypersontodoanythingtoremedy,mitigateor
...
(b) which would not have occurred had the direction been
...
imposedbytheCommissionundersection48J(1)ontheorganisation
...
case,anapplicationforreconsiderationdoesnotsuspendtheeffectof
...
extendthetimefortheorganisationorpersontomaketheapplication
...
(6) Ifanapplicationforreconsiderationismadeinaccordancewith

this section, the Commission must —

(a) reconsider the direction or decision;

(b) takeanyofthefollowingactionsastheCommissionthinks

fit:

(i) affirm, revoke or vary the direction or decision;

(ii) affirmorrevoke,orvarytheamountof,thefinancial
...
(2) IftheCommissionhasmadeadecisionunderthisActinrespect
...
Panel,AppealCommitteesandtheirmembersandtheproceedingsof
...
section48N,everyappealinrespectofthesamedirectionordecision
...
(2) Anappealunderthissectionmaybemadewithintheprescribed
...
(3) TheGeneralDivisionoftheHighCourtistohearanddetermine
...
(2) Guidelinesissuedunderthissectionmay bevaried,amendedor
...
whetherornotanorganisationorapersoniscomplyingwiththisAct,

includingavoluntaryundertakinggivenbytheorganisationorperson
...
(3) TheCommissionmaysuspend,discontinueorrefusetoconduct
...
anorganisationorapersonundersection48L(1)inrelation
...
(ii) anyothercircumstanceswarrantrefusingtoconduct,
...
mayconductorresumeaninvestigationunderthissectionatanytime

if an organisation or a person fails to comply with a voluntary

undertakinggivenbytheorganisationorpersonundersection48L(1)
...
dataoruser‑provideddata(asthecasemaybe)includespersonaldata

about another individual.

[40/2020]

(2) Apersonguiltyofanoffenceundersubsection(1)shallbeliable

onconvictiontoafinenotexceeding$5,000ortoimprisonmentfora
...
disposesof,alters,falsifies,concealsordestroys,ordirects
...
(ii) informationaboutthecollection,useordisclosureof
...
(a) inthecaseofanindividual,toafinenotexceeding$10,000
...
(a) anofficer,employeeoragentofthecorporationengagedin

that conduct within the scope of the actual or apparent

authorityoftheofficer,employeeoragent,asthecasemay
...
corporationandinapositiontoinfluencetheconduct
...
offencebythecorporation(oranoffenceofthesame
...
offencewith whichthe personis charged and,in doingso,the person
...
partnershipengagedinthatconductwithinthescopeofthe
...
isevidencethattheunincorporatedassociationorpartnershiphadthat
...
thisAct,andapplieswhetherornottheunincorporatedassociationor
...
courseof his or heremployment (calledin thissectiontheemployee)
...
(2) InanyproceedingsforanoffenceunderthisActbroughtagainst

any person in respect of an act or conduct alleged to have been done

orengagedin(asthecasemaybe)byanemployeeofthatperson,itis
...
ofhisorheremployment,actsorconduct(asthecasemaybe)ofthat

description.

Jurisdiction of court

## 54. DespiteanyprovisiontothecontraryintheCriminalProcedure
...
3yearsortobothand,inthecaseofacontinuingoffence,toafurther
...
(b) whetherinformationexists,ifanorganisationinrefusingto
...
(2) Apersonwhofailstocomplywithsubsection(1)shallbeguilty
...
offence,discloseinformationrelatingtothecommissionof
...
(f) toapublicbodyinsuchcircumstancesastheMinistermay

prescribe.

(6) The conditions mentioned in subsection (5)(e) are —

(a) thattheinformationordocumentsrequestedbytheforeign
...
performtherelevantbody’sfunctionsorduties,orexercise
...
(c) aninspectororapersonauthorised,appointedoremployed
...
toassisttherelevantbodyintheexerciseofits powers,the
...
## 61.—(1) TheCommissionhastheexclusiverighttotheuseofsuch
...
astodeceiveorcauseconfusion,ortobelikelytodeceiveortocause
...
approvaloftheMinister,makeregulationsfororwithrespecttoallor
...
thatanorganisationmaychargeinrespectofsuchrequests;

(ba) theassessmentandnotificationofnotifiabledatabreaches,
...
(i) thestepsandmeasuresthatanorganisationmusttake

inrelationtotheinvestigationandassessmentofdata
...
(i) theinformationandparticularsthatmustbeprovided
...
applicabledatatransmittedbyaportingorganisation;
...
Committee,includingthefeestobepaid inrespectof such
...
(l) anyothermatter relating to theestablishment, operation or
...
(3) Regulationsmadeunderthissectionmayprovidedifferentlyfor
...
## 67.—(1) EveryactdonebyoronbehalfoftheFormerCommission
...
applicationmadetotheCommissionunderthisAct,totheextentthat
...
(5) Any appealmadebefore 1October 2016under Part8in respect
...
(6) Anyauthorisationmadeby,oranycertificateorotherdocument
...
(2) Inthissection,“FormerCommission”hasthemeaninggivenby
...
Section17(1)andFifthand

TwelfthSchedules

COLLECTION, USE AND DISCLOSURE OF

PERSONAL DATAWITHOUT CONSENT
...
(a) consentforthecollection,useordisclosure(asthecasemaybe)cannot

be obtained in a timely way; or

(b) theindividual wouldnot reasonablybeexpectedto withhold consent.

(2) Where the organisation collects, uses or discloses (as the case may be)

personaldataabouttheindividualundersub‑paragraph(1),theorganisationmust,

assoonasispracticable,notifytheindividualofthecollection,useordisclosure
...
## 2. Thecollection,use ordisclosure (asthecase maybe) ofpersonaldataabout

anindividualisnecessarytorespondtoanemergencythatthreatensthelife,health

or safety of the individual or another individual.

## 3. Thecollection,use ordisclosure (asthecase maybe) ofpersonaldataabout
...
(b) therearereasonablegroundstobelievethatthehealthorsafetyofthe
...
## 1. Thecollection,use ordisclosure (asthecase maybe) ofpersonaldataabout
...
## 4. Thecollection,use ordisclosure (asthecase maybe) ofpersonaldataabout
...
articlesorprogrammesoforconcerningnews,observationson

news,orcurrentaffairs,forthepurposesofdisseminationtothe
...
(b) thedissemination,to thepublic oranysection ofthepublic,of
...
fromSingaporeandholdsabroadcastinglicencegrantedunder
...
aboutanindividualisinthelegitimateinterestsoftheorganisationor
...
(b) providetheindividualwithreasonableaccesstoinformationaboutthe

organisation’scollection,useordisclosureofpersonaldata(asthecase
...
disclosure(asthecasemaybe)ofpersonaldataaboutanindividualis
...
personaldataaboutanindividualforthepurposeofsending tothat individualor
...
## 5. Thecollection,use ordisclosure (asthecase maybe) ofpersonaldataabout

anindividualisnecessaryfortheprovisionoflegalservicesbytheorganisationto
...
(b) relatestoacreditreportprovidedbyacreditbureautoamemberofthe

credit bureau in relation to a transactionbetween the member and the
...
## 7. Thecollection,use ordisclosure (asthecase maybe) ofpersonaldataabout

an individual is to —

(a) conferaninterestorabenefitontheindividualunderaprivatetrustor

benefit plan; and

(b) administerthattrustorbenefitplan,attherequestofthesettlororthe
...
organisationtoprovideaserviceforthepersonalordomesticpurposes

of that other individual; and

(b) iscollected,usedordisclosed(asthecasemaybe)bytheorganisation

solely for the purpose in sub‑paragraph (a).

## 9. The personal data about an individual —

(a) isincludedinadocumentproducedinthecourse,andforthepurposes,
...
## 10. Thepersonaldataaboutanindividualiscollected,usedordisclosed(asthe

casemaybe)bytheorganisation,andthecollection,useordisclosure(asthecase

maybe) ofthepersonal dataisreasonable forthepurposeof or in relationto the
...
anorganisation(X)isapartyoraprospectivepartytoabusinessassettransaction

withanotherorganisation(Y),personaldataaboutanapplicableindividualofY—

(a) is collected from Y by X for the purposes of the business asset

transaction;

(b) isusedordisclosedbyXinrelationtothebusinessassettransaction;or

(c) is disclosed by Y to X for the purposes of the business transaction.

(2) Where thebusiness asset transaction concerns anypart of Y or Y’s business
...
(a) Xmaycollect,andYmaydisclose,onlypersonaldatathatisnecessary

for X to determine whether to proceed with the business asset

transaction;

(b) XandYmusthaveenteredintoanagreementthatrequiresXtouseor

disclose the personal data solely for purposes related to the business

asset transaction.

(4) IfXentersintothebusinessassettransaction,thefollowingconditionsapply:

(a) XmayuseordisclosethepersonaldataXcollectedfromYonlyforthe
...
(b) ifanypersonaldataXcollectsfromYdoesnotrelatedirectlytothepart

of Y or Y’s business assets with which the business asset transaction

enteredintoisconcerned,Xmustdestroy,orreturntoY,thatpersonal

data;

(c) XorYmustnotifytheapplicableindividualsofYwhosepersonaldata
...
(5) Ifthebusinessassettransactiondoesnotproceedorisnotcompleted,Xmust
...
(b) isusedordisclosedbyXorYinrelationtotherelevanttransaction;or
...
onlypersonaldatathatisnecessaryforXtodeterminewhether
...
necessaryforXorY(asthecasemaybe)todeterminewhether
...
(ii) YandZmusthaveenteredintoanagreementthatrequiresYto

useordisclosethepersonaldatasolelyforpurposesrelatedto
...
casemaybe)onlyforthesamepurposesforwhichYorZ(asthecase
...
“applicableindividual”,inrelationtoanorganisation,includesacontractor,a
...
(a) meansthepurchase,sale,lease,mergeroramalgamationorany
...
(ii) thetransferordisposalofanyofthebusinessorassets
...
(c) inrelationtoabusinesstrust—aunitinthatbusinesstrust;and
...
(a) iscollectedbyanorganisation(X)thatisacorporationfromarelated

corporation(Y)forapurposespecifiedinsub‑paragraph(2)(calledthe
...
(a) improvingorenhancinganygoodsorservicesprovided,ordeveloping

new goods or services to be provided, by X or Y;

(b) improvingorenhancingthemethodsorprocesses,ordevelopingnew

methods or processes, for the operations of X or Y;

(c) learning about and understanding the behaviour and preferences of P

oranotherindividualinrelationtothegoodsorservicesprovidedbyX
...
(a) therelevantpurposeforwhichXcollects,orYdiscloses,personaldata

about P cannot reasonably be achieved without the collection, use or

disclosure(asthecasemaybe)ofthepersonaldatainanindividually

identifiable form;

(b) a reasonable person would consider the collection or disclosure of

personaldataaboutPfortherelevantpurposetobeappropriateinthe
...
“prospectivecustomerofX”meansanindividualwho,atthetimementioned

in paragraph 1(5) —

(a) hasinformedXoftheindividual’sinterestinpurchasing,hiring
...
DISCLOSURE OF PERSONAL DATAWITHOUT CONSENT
...
(b) thecollectionofthepersonaldatabytheorganisationisconsistentwith
...
cannotreasonablybeachievedwithouttheuseofthepersonaldatain
...
(3) Toavoiddoubt,sub‑paragraph(1)doesnotapplytotheuseofpersonaldata
...
(4) Inthisparagraph,“organisation”excludesacorporationwithinthemeaning

given by section 4(1) of the Companies Act 1967.

Division 3 — Research

## 1. Theuseofpersonaldataaboutanindividualforaresearchpurpose(including
...
(b) thereisaclearpublicbenefittousingthepersonaldatafortheresearch
...
## 1. Thedisclosureofpersonaldataaboutanindividualtoapublicagency,where

the disclosure is necessary in the public interest.

## 2. Thedisclosureofpersonaldataaboutanindividualwhoisacurrentorformer

studentofaneducationalinstitutiontoapublicagencyforthepurposesofpolicy

formulation or review.

## 3. Thedisclosureofpersonaldataaboutanindividualwhoisacurrentorformer

patient of any of the following to a public agency for the purposes of policy

formulation or review:

(a) [Deleted by Act 19 of 2025 wef 05/12/2025]
...
(b) itisimpracticablefortheorganisationtoseektheindividual’sconsent
...
## 1. Anorganisationisnotrequiredtoprovideinformationundersection21(1)in
...
(d) personaldatakeptbyanarbitralinstitutionoramediationcentresolely

for thepurposes of arbitration or mediationproceedings administered
...
conductofamediationorarbitrationforwhichheorshewasappointed
...
Act1960orbyagreementbetweenthepartiestothemediation
...
organisation because of therepetitious or systematic nature of
...
## 2. Forthepurposesofparagraph1(j)(i),theorganisationmayhaveregardtothe
...
## 1.—(1) TheDataProtectionAppealPanelconsistsofnotmorethan30members

appointedbytheMinisteronthebasisoftheirabilityandexperienceinindustry,

commerceoradministrationortheirprofessionalqualificationsortheirsuitability

otherwise for appointment.

(2) MembersoftheAppealPanelareappointedforsuchperiodastheMinister

may determine and are eligible for re‑appointment.

(3) TheMinistermayatanytimerevoketheappointmentofanymemberofthe
...
revokedbytheMinisterorunlessheorsheresignsduringhisorhertermofoffice,

holds office for such period as the Minister may determine and is eligible for

re‑appointment.

(2) TheMinistermayappointanymembertobeatemporaryChairpersonofthe

AppealPanelduringthetemporaryincapacityfromillnessorotherwiseorduring

the temporary absence from Singapore of the Chairperson of the Appeal Panel.

Secretary to Appeal Panel

## 2A.—(1) TheSecretaryto theAppealPanelistobeappointedbytheMinister.

(2) The Secretary is to provide administrative and secretarial support to the

ChairpersonoftheAppealPanel,theAppealPanelandeveryAppealCommittee,

in the discharge of their functions, duties and powers under this Act.

(3) TheSecretaryistoactinaccordancewiththeinstructionsoftheChairperson
...
(b) keepingtherecordsofproceedingsrelatingtoappealsinsuchformas

the Chairperson may direct.

(4) TheSecretaryandanypersonauthorisedundersub‑paragraph(5)mayattend

any meeting of an Appeal Committee to carry out their functions under this Act.

(5) TheSecretarymaybeassistedincarryingouttheSecretary’sfunctionsunder
...
(2) FortheproperfunctioningofanyAppealCommittee,theChairpersonofthe
...
(3) ThereconstitutionofanAppealCommitteeundersub‑paragraph(2)(b)does
...
AppealCommitteechosenbythemembersofthatAppealCommitteepresentisto
...
(4) AnymemberoftheAppealPanelwhosetermofappointmentexpiresinthe

courseofproceedingsbyanAppealCommitteetowhichthememberisappointed

continuesasamemberofthatAppealCommitteeuntiltheAppealCommittee—

(a) completes its work on the appeal; or

(b) isearlierreconstitutedunderparagraph2B(2)(b)withoutthatmember.

(5) AnAppealCommitteeistomeetforanypurposeunderthisActatsuchtimes

and places as determined by the presiding member before the meeting.

Powers of Appeal Committees

## 4.—(1) AnAppealCommitteehasallthepowersanddutiesoftheCommission

thatarenecessarytoperformitsfunctionsanddischargeitsdutiesunderthisAct.
...
capableofbeingissuedinanactionforenforcingtheattendanceofwitnessesand

compelling the production of documents.

(4) Where any person being duly summoned to attend before an Appeal

Committeedoesnotsoattend,thatpersonshallbeguiltyofanoffenceandshallbe

liableonconvictiontoafinenotexceeding$5,000ortoimprisonmentforaterm

not exceeding 6 months or to both.

(5) Awitness before an Appeal Committee is entitled to the same immunities

and privileges as if he or she were a witness before a District Court.

(6) Allappealsmustbedetermined,havingregardtothenatureandcomplexity
...
(9) SubjecttootherprovisionsofthisActandregulationsmadeunderthisAct,

an Appeal Committee may regulate its own procedure.

Allowances

## 5. MembersoftheAppealCommitteemayreceivesuchremunerationandsuch
...
Committee,anyvacancyin,ordefectintheconstitutionof,theAppeal

Committee; or

(b) anydefectintheappointmentoftheChairpersonoftheAppealPanel,

oranymember(orpresidingmember)ofanAppealCommittee,asthe
...
## 1.—(1) ForthepurposesofPart9,aspecifiedmessagedoesnotincludeanyof
...
(i) tofacilitate,completeorconfirmatransactionthattherecipient

of the message has previously agreed to enter into with the

sender;

(ii) toprovidewarrantyinformation,productrecallinformationor
...
upgrades,thattherecipientofthemessageisentitledtoreceive

under the terms of a transaction that the recipient has

previously agreed to enter into with the sender;

(e) anymessage,otherthanamessagementionedinsub‑paragraph(d)—

(i) that issentwhilethesenderisin anongoing relationshipwith
...
(f) anymessagethesolepurposeofwhichistoconductmarketresearchor

market survey;

(g) anymessagesenttoanorganisationotherthananindividualactingina

personal or domestic capacity, for any purpose of the receiving

organisation.

(2) Insub‑paragraph(1)(e),“ongoingrelationship”meansarelationship,onan

ongoing basis,betweenthesenderandtherecipient ofthemessage,arisingfrom

thecarryingonorconductofabusinessoranactivity(commercialorotherwise)
...
oraninspectormay,bywrittennoticetoanyorganisation,requiretheorganisation

to produceto theCommissionortheinspectoraspecifieddocumentor specified
...
employedbytheorganisation,toprovideanexplanationofthe

document; or

(b) if thedocumentis not produced, to requirethe organisation or person
...
(b) fallingwithinacategorywhichisspecifiedordescribedinthenotice.

Power to require provision of information, etc.

## 1A.—(1) Forthepurposesofaninvestigationundersection50,theCommission

or an inspector may do all or any of the following:

(a) require, by written notice, any person whom the Commission or

inspectorreasonablybelieveshasanyinformation,oranydocumentin

theperson’scustodyorcontrol,thatisrelevanttotheinvestigation,to

providethatinformationorproducethatdocument,withinthetimeand
...
(c) examineorallyanypersonwhoappearstobeacquaintedwiththefacts

or circumstances of the matter.

(2) A person examined under sub‑paragraph (1)(c) is bound to state truly the

factsandcircumstanceswithwhichthepersonisacquaintedconcerningthematter

except that the person need not say anything that might expose the person to a

criminal charge, penalty or forfeiture.

(3) Astatementmadebyapersonexaminedundersub‑paragraph(1)(c)must—

(a) be reduced to writing;

(b) be read over to the person;

(c) ifthepersondoesnotunderstandEnglish,beinterpretedinalanguage
...
suchotherpersonsastheinspectormayrequiretoassisthimorher,mayenterany

premises.

(2) Aninspectororapersonassistingtheinspectormustnotenteranypremises

in exercise of thepowers under this paragraph unless theinspector has given the
...
(3) Sub‑paragraph(2)doesnotapplyiftheinspectorhasreasonablegroundsfor

suspectingthatthepremisesare,orhavebeen,occupiedbyanorganisationwhich

isbeinginvestigatedinrelationtoacontraventionofthisActandiftheinspector

hastakenallsuchstepsasarereasonablypracticabletogivewrittennoticeunder
...
(5) Aninspectororapersonassistingtheinspectorenteringanypremisesunder
...
accessible from thepremises andwhich he or she considers relates to
...
preserving or preventing interference with any documentwhich heor

she considers relates to any matter relevant to the investigation.

Power to enter premises under warrant

## 3.—(1) TheCommissionoranyinspectormayapplytoacourtforawarrantand
...
(i) there are, on any premises,documents which theCommission

or the inspector has power under paragraph 1 to require to be

produced; and

(ii) ifthedocumentswererequiredtobeproduced,theywouldnot

beproducedbutwouldbeconcealed,removed,tamperedwith

or destroyed; or

(c) an inspectoror aperson assisting theinspector has attempted to enter

thepremisesintheexerciseofhisorherpowersunderparagraph2but
...
suspectingthatthereare,onthepremises,documentstheproductionof

which could have been required under that paragraph.

(2) Awarrant under this paragraph authorises a named officer, and such other
...
(b) tosearchanypersononthosepremisesiftherearereasonablegrounds
...
documentappearingtobeofakindinrespectofwhichtheapplication

under sub‑paragraph (1) was granted (the relevant kind);

(d) totakepossessionofanydocumentappearingtobeoftherelevantkind
...
(ii) it isnot reasonably practicableto takecopies of the document
...
(g) torequireanyinformationwhichisstoredinanyelectronicformandis
...
(3) If,inthecaseofawarrantundersub‑paragraph(1)(b),thecourtissatisfied

thatitisreasonabletosuspectthattherearealsoonthepremisesotherdocuments
...
(3),thenamedofficermay,attherequestofthepersonfromwhompossessionof

the document was taken, provide such person with a copy of the document.

(5) Anamedofficermayallowanyequipmentorarticlewhichhasabearingon
...
(6) Awarrant issued under this paragraph —

(a) mustindicatethesubjectmatterandpurposeoftheinvestigation;and
...
(9) Ifthereisnooneatthepremiseswhenthenamedofficerproposestoexecute

such a warrant, the named officer must, before executing it —

(a) takesuchstepsasarereasonableinallthecircumstancestoinformthe

occupier of the intended entry; and

(b) iftheoccupierisinformed,givetheoccupierortheoccupier’slegalor

other representative a reasonable opportunity to be present when the

warrant is executed.

(10) Ifthenamedofficerisunabletoinformtheoccupieroftheintendedentry,

thenamedofficermust,whenexecutingthewarrant,leaveacopyofthewarrantin

a prominent place on the premises.

(11) Onleavinganypremiseswhichthenamedofficerhasenteredbyvirtueofa
...
(12) Anydocumentofwhichpossessionistakenundersub‑paragraph(2)(d)or
...
“occupier”,in relationtoanypremises,meansapersonwhomtheinspector
...
possessionorunderthecontrolofanorganisationorapublicagency,asthecase
...
## 3. Assessing,testingorevaluatingthesystemsandprocessesofanorganisation

orapublicagencyforensuringorsafeguardingtheintegrityandconfidentialityof
...
ThisLegislativeHistoryisaserviceprovidedbytheLawRevisionCommission
...
(exceptsections36to38,41and43to
...
2December2013(sections36,37,38

and 41)

2January2014(sections43 to48and
...
(Amendmentsmadebysection28(1)readwithitem115oftheScheduletothe
...
## 9. Act 19 of 2025 — Statutes (Miscellaneous Amendments) Act 2025

Bill : 9/2025

First Reading : 22 September 2025

Second and Third Readings : 15 October 2025
